...
public class SolutionTest {
    ...
    public void secondTest() throws IOException {
        ...
        String input = "";
        try (Stream<String> linesIn = java.nio.file.Files.lines(Paths.get("input/input12.txt"))) {
            input = linesIn.collect(Collectors.joining("\n"));
        }
        String expected = "";
        try (Stream<String> linesOut = java.nio.file.Files.lines(Paths.get("output/output12.txt"))) {
            expected= linesOut.collect(Collectors.joining("\n"));
        }
